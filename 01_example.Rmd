...
- [Output -- GitHub 01_example.html](01_example.htmls)


## Background

While it is possible for a parent R Markdown document (.Rmd) to use externalized code chunks from child R Markdown documents (also .Rmd).  The seemingly most logical approach is to have the child chuncks come from standar .R scripts.

## Steps

1. Have a parent .Rmd script (01_example.Rmd)
1. Have at least one child .R script (src/example_starwars.R)
